...
public class MovieGenre {
	...
	public static final String SCIFI_AND_FANTASY = "Sci_And_Fantasy";
	public static final String COMEDY = "Comedy";
	public static final String CHILDREN_AND_FAMILY = "Children_And_Family";
	public static final String ACTION_AND_ADVENTURE = "Action_And_Adventure";
	public static final String THRILLERS = "Thrillers";
	public static final String MUSIC_AND_MUSICALS = "Music_And_Musicals";
